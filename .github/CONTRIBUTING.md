...
# PlexMediaManager Contributing Guide
Hello and thank you for interest in helping make PlexMediaManager better. Please take a few moments to review the following guidelines.
...
* If reproduceable, please provide a repository that can be cloned to produce the expected behavior. It is preferred that you create an initial commit with no changes first, then another one that will cause the issue. 
